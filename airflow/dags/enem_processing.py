...
def pipeline_enem():
    ...
    def emr_process_enem_data():
        ...
        Instances={
            ...
            "Ec2KeyName": "kraisfeld-ec2-airflow",
            ...
            Steps=[{
                ...
                'HadoopJarStep': {
                    ...
                    "Args": [
                        ...
                        "--deploy-mode",
                        "cluster",
                        "s3://datalake-kraisfeld-igti-edc-tf/emr-code/pyspark/01_delta_spark_insert.py",
                    ],
                }
            }],
        )
                ...
                Steps=[{
                    ...
                    'HadoopJarStep': {
                        ...
                        "Args": [
                            ...
                            "--deploy-mode",
                            "cluster",
                            "s3://datalake-kraisfeld-igti-edc-tf/emr-code/pyspark/02_delta_spark_upsert.py",
                        ],
                    }
                }]
            )
